...
<table>
  <tr>
    <th>Type</th>
    <th>Meaning</th>
    <th>C typedef declaration</th>
  </tr>
  <tr>
    <td>int8</td>
    <td>unsigned 8-bit value</td>
    <td>typedef unsigned char int8;</td>
  </tr>
  <tr>
    <td>sint8</td>
    <td>signed 8-bit value</td>
    <td>typedef char sint8;</td>
  </tr>
  <tr>
    <td>int16</td>
    <td>unsigned 16-bit value</td>
    <td>typedef unsigned short int16;</td>
  </tr>
  <tr>
    <td>sint16</td>
    <td>signed 16-bit value</td>
    <td>typedef short sint16;</td>
  </tr>
  <tr>
    <td>int32</td>
    <td>unsigned 32-bit value</td>
    <td>typedef unsigned long int32;</td>
  </tr>
  <tr>
    <td>sint32</td>
    <td>signed 32-bit value</td>
    <td>typedef long sint32;</td>
  </tr>
  <tr>
    <td>int64</td>
    <td>unsigned 64-bit value</td>
    <td>typedef unsigned long long int64;</td>
  </tr>
  <tr>
    <td>sint64</td>
